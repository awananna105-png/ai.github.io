    ...
    <section id="demo" class="section">
        <div class="container demo-container">
            ...
            <div class="demo-content">
                ...
                <button id="replay-demo" class="btn btn-outline" style="margin-top: 20px;">↻ Replay Simulation</button>
            </div>

            <!-- Right: Phone UI Animation -->
            <div class="chat-ui">
                <div class="chat-header">
                    🕻 Incoming Call: (555) 012-3456
                </div>
        ...
        <div class="container">
            ...
            <div class="card-grid" style="max-width: 900px; margin: 0 auto; grid-template-columns: 1fr 1fr;">
                ...
                <div class="pricing-card featured">
                    ...
                    <ul class="pricing-features">
                        <li>➝ <strong>Unlimited</strong> Minutes</li>
                        <li>➝ 24/7 Full Replacement</li>
                        <li>➝ CRM Integration (ServiceTitan)</li>
